...
export class TownScene extends Phaser.Scene {
  ...
  private spawnTrees(): void {
    ...
    for (const [x, y] of treePositions) {
      ...
      tree.setDepth(1);
      // Hitbox auf den Stamm begrenzen
      tree.body.setSize(12, 12);
      tree.body.setOffset(10, 16);
    }
  }
  ...
  // ============================================================
  //  NPCS, GEGNER, ZONEN (unverändert von dir)
  // ============================================================
  ...
  private spawnEnemies(cx: number, cy: number): void {
    ...
    for (const data of enemyData) {
      ...
      // Gegner kollidieren mit Wänden und Bäumen
      if (this.wallLayer) {
