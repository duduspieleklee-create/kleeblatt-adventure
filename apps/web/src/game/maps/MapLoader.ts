...
/**
 * Load and validate the static island tilemap (ported from kleeblock).
 * Visual layers stay separate from collision.
 */
export function loadIslandMap(
  ...
  const collisionLayer = map.createLayer("collision", tileset, 0, 0, false) as
