...
async function constructVerifiedMints(ctx, dto, tokenClass, instanceCounter, callingUser) {
    var _a;
    ...
    if (tokenClass.isNonFungible) {
        ...
        for (let i = 0; i < quantity.toNumber(); i += 1) {
            ...
            const nftInfo = await (0, api_1.createValidChainObject)(api_1.TokenInstance, {
                collection,
                category,
                type,
                additionalKey,
        ...
        const fungibleReturnInstance = await (0, api_1.createValidChainObject)(api_1.TokenInstance, {
            collection,
            category,
            type,
            additionalKey,
...
//# sourceMappingURL=constructVerifiedMints.js.map