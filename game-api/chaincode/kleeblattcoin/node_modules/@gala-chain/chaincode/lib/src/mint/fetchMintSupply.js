...
exports.fetchMintSupply = void 0;
...
async function fetchMintSupply(ctx, tokenClass, offsetCurrentTimeMs) {
    ...
    try {
        for await (const kv of iterator) {
            ...
            if (kv.value) {
                ...
                const entry = api_1.RangedChainObject.deserialize(api_1.TokenMintRequest, stringResult);
    ...
    let startingKnownMintsCount = new bignumber_js_1.default("0");
    let updatedKnownMintsCount = new bignumber_js_1.default("0");
    ...
    for (const entry of previousRequests) {
        if (firstResult && entry.totalKnownMintsCount.isGreaterThan(startingKnownMintsCount)) {
            ...
            updatedKnownMintsCount = new bignumber_js_1.default(entry.totalKnownMintsCount);
        }
        firstResult = false;
...
exports.fetchMintSupply = fetchMintSupply;
//# sourceMappingURL=fetchMintSupply.js.map