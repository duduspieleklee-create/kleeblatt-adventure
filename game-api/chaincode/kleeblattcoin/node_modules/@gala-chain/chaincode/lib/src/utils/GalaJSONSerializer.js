...
const Logger = tslib_1.__importStar(require("fabric-contract-api/lib/logger"));
/*
...
class GalaJSONSerializer {
    ...
    toBuffer(result, schema = {}, loggerPrefix) {
        ...
        if (!(typeof result === "undefined" || result === null)) {
            ...
            if (schema.type && (schema.type === "string" || schema.type === "number")) {
                ...
                const payload = (0, api_1.serialize)(result);
    ...
    _fromString(stringData, fullschema, loggerPrefix) {
        ...
        if (schema.type) {
            if (schema.type === "string") {
                ...
                if (cnstr) {
                    ...
                    value = (0, class_transformer_1.plainToInstance)(cnstr, jsonForValidation);
                    return { value, jsonForValidation };
                }
        ...
        try {
            ...
            logger.error("fromBuffer could not parse data as JSON to allow it to be converted to type: " +
                JSON.stringify(schema.type), stringData, err);
...
exports.default = GalaJSONSerializer;
//# sourceMappingURL=GalaJSONSerializer.js.map