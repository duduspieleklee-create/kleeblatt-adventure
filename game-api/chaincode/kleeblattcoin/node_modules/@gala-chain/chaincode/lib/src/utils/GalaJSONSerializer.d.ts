...
export default class GalaJSONSerializer {
     ...
     */
    toBuffer(result: any, schema?: {
        type?: string;
    }, loggerPrefix?: string): Buffer | undefined;
    /**
     ...
     *
     */
    fromBuffer(data: any, fullschema: any, loggerPrefix: any): {
        value: any;
        jsonForValidation: any;
    };
    _fromString(stringData: string, fullschema: any, loggerPrefix: any): {
        value: any;
        jsonForValidation: any;
    };
}
//# sourceMappingURL=GalaJSONSerializer.d.ts.map