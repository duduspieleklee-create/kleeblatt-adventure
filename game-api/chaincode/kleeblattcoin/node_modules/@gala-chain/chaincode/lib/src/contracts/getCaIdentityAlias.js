...
exports.getCaIdentityAlias = void 0;
/*
 ...
 * @deprecated
 */
function getCaIdentityAlias(ctx) {
    const clientAccountID = ctx.clientIdentity.getID();
    const OUPrefix = "::/OU=";
    const OUSuffix = "/";
    const CNPrefix = "/CN=";
    const CNSuffix = ":";
    if (!clientAccountID.startsWith("x509::") ||
    ...
    return (0, api_1.asValidUserAlias)(`${org}${ID_SUB_SPLIT_CHAR}${name}`);
}
exports.getCaIdentityAlias = getCaIdentityAlias;
//# sourceMappingURL=getCaIdentityAlias.js.map