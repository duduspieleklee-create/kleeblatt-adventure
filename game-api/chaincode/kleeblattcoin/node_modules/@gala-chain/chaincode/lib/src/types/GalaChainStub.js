...
exports.createGalaChainStub = exports.DuplicateInvokeChaincodeError = void 0;
/*
 ...
 */
class StubCache {
    constructor(stub, isReadOnly, index) {
        this.stub = stub;
    ...
    async flushWrites() {
        if (this.isReadOnly) {
            throw new api_1.NotImplementedError("Cannot flush writes in read-only mode");
        }
...
class DuplicateInvokeChaincodeError extends api_1.NotImplementedError {
    constructor(chaincodeName, args, channel) {
...
exports.DuplicateInvokeChaincodeError = DuplicateInvokeChaincodeError;
const createGalaChainStub = (stub, isReadOnly, index) => {
...
//# sourceMappingURL=GalaChainStub.js.map