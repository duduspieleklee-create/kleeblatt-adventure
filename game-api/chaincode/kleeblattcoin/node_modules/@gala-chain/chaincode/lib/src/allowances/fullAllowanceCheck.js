    ...
    for (const balance of balances) {
        for (const instanceId of balance.getNftInstanceIds()) {
            ...
            const expiredAllowances = allowanceResults.filter((allowance) => {
                var _a, _b;
                return ((!!allowance.usesSpent && ((_a = allowance.usesSpent) === null || _a === void 0 ? void 0 : _a.isGreaterThanOrEqualTo(allowance.uses))) ||
                    (!!allowance.quantitySpent &&
                        ((_b = allowance.quantitySpent) === null || _b === void 0 ? void 0 : _b.isGreaterThanOrEqualTo(allowance.quantity))) ||
...
//# sourceMappingURL=fullAllowanceCheck.js.map