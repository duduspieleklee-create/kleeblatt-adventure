    ...
    for (const [, values] of Object.entries(reqIdx)) {
        ...
        for (const req of values) {
            ...
            if (req.isTimeKeyValid() === false) {
                throw new Error(`FulfillMintAllowance failure: Invalid timeKey value: ${req.timeKey}. The value of timeKey should be a valid BigNumber, ${(0, util_1.inspect)(req, {
                    depth: 4,
...
//# sourceMappingURL=fulfillMintAllowance.js.map