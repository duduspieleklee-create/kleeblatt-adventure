...
async function createTokenClass(ctx, params) {
    ...
    const newToken = await (0, api_1.createValidChainObject)(api_1.TokenClass, {
    ...
    if (!newToken.isNonFungible) {
        const defaultInstance = await (0, api_1.createValidChainObject)(api_1.TokenInstance, {
...
//# sourceMappingURL=createTokenClass.js.map