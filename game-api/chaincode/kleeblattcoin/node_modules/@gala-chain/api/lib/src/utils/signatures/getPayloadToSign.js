...
function getEIP712PayloadToSign(obj, eipOverride) {
...
function getPayloadToSign(obj, eipOverride = {}) {
    // eslint-disable-next-line @typescript-eslint/no-unused-vars
    const { signature, multisig, trace, prefix, ...plain } = (0, class_transformer_1.instanceToPlain)(obj);
    const dataString = isEIP712Object(plain)
        ? getEIP712PayloadToSign(plain, eipOverride)
        : `${prefix !== null && prefix !== void 0 ? prefix : ""}${(0, serialize_1.default)(plain)}`;
