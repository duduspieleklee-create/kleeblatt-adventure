    ...
    const schema = (0, class_validator_jsonschema_1.targetConstructorToSchema)(classType, {
        additionalConverters: {
            ...
            ["IsValidChainAddressConstraint"]: () => {
                return {
                    type: "string",
                    description: "Allowed value is a valid chain address: Ethereum (checksummed with 0x prefix), Solana (base58-encoded 32-byte public key), TON (non-bounceable mainnet format: UQ...), or GalaChain (valid user alias)."
                };
            }
        },
