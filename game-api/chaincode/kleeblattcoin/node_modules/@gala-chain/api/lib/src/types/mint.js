...
let MintTokenDto = class MintTokenDto extends dtos_1.SubmitCallDTO {
};
...
let MintTokenWithAllowanceDto = class MintTokenWithAllowanceDto extends dtos_1.SubmitCallDTO {
};
...
let BatchMintTokenDto = class BatchMintTokenDto extends dtos_1.SubmitCallDTO {
};
 ...
 */
let HighThroughputMintTokenDto = class HighThroughputMintTokenDto extends dtos_1.SubmitCallDTO {
};
...
let FulfillMintDto = class FulfillMintDto extends dtos_1.SubmitCallDTO {
};
...
tslib_1.__decorate([
    (0, class_validator_jsonschema_1.JSONSchema)({
        description: "Start of time range as a Unix epoch timestamp in milliseconds (ms) (inclusive lower bound for queries)."
    }),
    (0, class_validator_1.IsNotEmpty)(),
...
tslib_1.__decorate([
    (0, class_validator_jsonschema_1.JSONSchema)({
        description: "End of time range as a Unix epoch timestamp in milliseconds (ms) (inclusive upper bound for queries)."
    }),
    (0, class_validator_1.IsNotEmpty)(),
    tslib_1.__metadata("design:type", Number)
...
let PatchMintAllowanceRequestDto = class PatchMintAllowanceRequestDto extends dtos_1.SubmitCallDTO {
};
...
let PatchMintRequestDto = class PatchMintRequestDto extends dtos_1.SubmitCallDTO {
};
...
let TokenMintConfigurationDto = class TokenMintConfigurationDto extends dtos_1.SubmitCallDTO {
};
...
tslib_1.__decorate([
    (0, class_validator_jsonschema_1.JSONSchema)({
        description: "(optional) Specify a `MintFeeConfiguration` to define " +
            "additional properties that affect $GALA `MintToken` fees"
    }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.ValidateNested)(),
    (0, class_transformer_1.Type)(() => TokenMintConfiguration_1.MintFeeConfiguration),
    tslib_1.__metadata("design:type", TokenMintConfiguration_1.MintFeeConfiguration)
], TokenMintConfigurationDto.prototype, "additionalFee", void 0);
...
class DeleteTokenMintConfigurationDto extends dtos_1.SubmitCallDTO {
}
exports.DeleteTokenMintConfigurationDto = DeleteTokenMintConfigurationDto;
tslib_1.__decorate([
    (0, class_validator_1.IsNotEmpty)(),
    tslib_1.__metadata("design:type", String)
], DeleteTokenMintConfigurationDto.prototype, "collection", void 0);
tslib_1.__decorate([
    (0, class_validator_1.IsNotEmpty)(),
    tslib_1.__metadata("design:type", String)
], DeleteTokenMintConfigurationDto.prototype, "category", void 0);
tslib_1.__decorate([
    (0, class_validator_1.IsNotEmpty)(),
    tslib_1.__metadata("design:type", String)
], DeleteTokenMintConfigurationDto.prototype, "type", void 0);
tslib_1.__decorate([
    (0, class_validator_1.IsDefined)(),
    tslib_1.__metadata("design:type", String)
], DeleteTokenMintConfigurationDto.prototype, "additionalKey", void 0);
