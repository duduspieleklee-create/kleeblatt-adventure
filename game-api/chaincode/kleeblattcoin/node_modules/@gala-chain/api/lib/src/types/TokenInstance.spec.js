...
it("should encode and decode token instance key from base58 encoded string", async () => {
    // Given
    const instance = new TokenInstance_1.TokenInstanceKey();
    instance.collection = "Test";
    instance.category = "Very";
    instance.type = "Large";
    instance.additionalKey = "Instance";
    instance.instance = new bignumber_js_1.default(1);
    const base58EncodedString = instance.toB58EncodedString();
    // When
    const decodedInstance = TokenInstance_1.TokenInstanceKey.fromB58EncodedString(base58EncodedString);
    // Then
