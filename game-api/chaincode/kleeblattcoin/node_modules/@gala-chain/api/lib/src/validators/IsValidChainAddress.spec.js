...
const IsValidChainAddress_1 = require("./IsValidChainAddress");
class TestDto extends types_1.ChainCallDTO {
}
tslib_1.__decorate([
    (0, IsValidChainAddress_1.IsValidChainAddress)(),
    tslib_1.__metadata("design:type", String)
], TestDto.prototype, "address", void 0);
class TestArrayDto extends types_1.ChainCallDTO {
}
tslib_1.__decorate([
    (0, IsValidChainAddress_1.IsValidChainAddress)({ each: true }),
    tslib_1.__metadata("design:type", Array)
], TestArrayDto.prototype, "addresses", void 0);
describe("GalaChain", () => {
...
describe("TON", () => {
    ...
    generatedTonSamples.forEach((v, i) => {
        it(`generated TON address ${i}`, async () => {
            expect([v.valid, (0, IsValidChainAddress_1.isValidChainAddress)(v.valid)]).toEqual([v.valid, true]);
            expect([v.bounceable, (0, IsValidChainAddress_1.isValidChainAddress)(v.bounceable)]).toEqual([v.bounceable, false]);
            expect([v.testOnly, (0, IsValidChainAddress_1.isValidChainAddress)(v.testOnly)]).toEqual([v.testOnly, false]);
            expect([v.both, (0, IsValidChainAddress_1.isValidChainAddress)(v.both)]).toEqual([v.both, false]);
        });
    });
});
...
it("should support schema generation", () => {
    ...
    // Then
    expect((_a = schema1.properties) === null || _a === void 0 ? void 0 : _a.address).toEqual(expect.objectContaining({
        type: "string"
    }));
    expect((_b = schema2.properties) === null || _b === void 0 ? void 0 : _b.addresses).toEqual(expect.objectContaining({
        type: "array"
    }));
});
//# sourceMappingURL=IsValidChainAddress.spec.js.map