...
const NftCollectionAuthorization_1 = require("./NftCollectionAuthorization");
describe("NftCollectionAuthorization", () => {
    it("should serialize collection authorization key", () => {
        // Given
        const collectionName = "TestCollection";
        const mockAuthorization = (0, class_transformer_1.plainToInstance)(NftCollectionAuthorization_1.NftCollectionAuthorization, {
        ...
        // Then
        expect(key).toEqual(`\u0000${NftCollectionAuthorization_1.NftCollectionAuthorization.INDEX_KEY}\u0000${collectionName}\u0000`);
    });
...
//# sourceMappingURL=NftCollectionAuthorization.spec.js.map