...
exports.SerializeIf = exports.BigNumberIsInteger = exports.BigNumberIsNotNegative = exports.BigNumberIsNotInfinity = exports.BigNumberIsPositive = exports.IsBigNumber = exports.ArrayUniqueObjects = exports.ArrayUniqueConcat = exports.IsDifferentValue = exports.IsWholeNumber = void 0;
 ...
 * ```
 */
function SerializeIf(condition, transformOptions) {
    return (0, class_transformer_1.Transform)(({ value, obj }) => {
        return condition(obj) ? value : undefined;
    }, transformOptions);
}
exports.SerializeIf = SerializeIf;
