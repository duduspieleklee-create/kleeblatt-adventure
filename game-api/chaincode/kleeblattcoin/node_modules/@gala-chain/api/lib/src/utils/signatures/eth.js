...
const CURVE_ORDER = new bn_js_1.default("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEBAAEDCE6AF48A03BBFD25E8CD0364141", "hex");
...
function secp256k1signatureFromDERHexString(hex) {
    ...
    const r = new bn_js_1.default(rHex, "hex");
...
function parseSecp256k1Signature(s) {
    ...
    const signatureString = part2 !== null && part2 !== void 0 ? part2 : part1;
...
function signSecp256k1(dataHash, privateKey, useDer) {
    ...
    const r = new bn_js_1.default(sigObj.signature.slice(0, 32));
    const s = new bn_js_1.default(sigObj.signature.slice(32, 64));
...
function recoverPublicKey(signature, obj) {
    ...
    const data = (0, getPayloadToSign_1.getPayloadToSign)(obj, { chainId: signatureObj.chainId });
    const dataHash = new Uint8Array(js_sha3_1.keccak256.digest(data));
...
function isValid(signature, obj, publicKey) {
    try {
        ...
        const data = typeof obj === "string" //
            ? Buffer.from(obj)
            : (0, getPayloadToSign_1.getPayloadToSign)(obj, { chainId: signatureObj.chainId });
