...
import { BurnToMintConfiguration, MintFeeConfiguration, PostMintLockConfiguration, TokenMintConfiguration } from "./TokenMintConfiguration";
import { UserRef } from "./UserRef";
import { MintRequestDto } from "./common";
import { ChainCallDTO, SubmitCallDTO } from "./dtos";
export declare class MintTokenDto extends SubmitCallDTO {
    static MAX_NFT_MINT_SIZE: number;
    tokenClass: TokenClassKey;
    owner?: UserRef;
    quantity: BigNumber;
}
export declare class MintTokenWithAllowanceDto extends SubmitCallDTO {
    tokenClass: TokenClassKey;
    owner?: UserRef;
    tokenInstance: BigNumber;
    quantity: BigNumber;
}
export declare class BatchMintTokenDto extends SubmitCallDTO {
 ...
 */
export declare class HighThroughputMintTokenDto extends SubmitCallDTO {
    static MAX_NFT_MINT_SIZE: number;
    tokenClass: TokenClassKey;
    owner?: UserRef;
    quantity: BigNumber;
}
export declare class FulfillMintDto extends SubmitCallDTO {
    static MAX_ARR_SIZE: number;
...
export declare class PatchMintAllowanceRequestDto extends SubmitCallDTO {
    collection: string;
    category: string;
    type: string;
    additionalKey: string;
...
export declare class PatchMintRequestDto extends SubmitCallDTO {
    collection: string;
    category: string;
    type: string;
    additionalKey: string;
...
export declare class TokenMintConfigurationDto extends SubmitCallDTO {
    collection: string;
    category: string;
    type: string;
    additionalKey: string;
...
export declare class DeleteTokenMintConfigurationDto extends SubmitCallDTO {
    collection: string;
    category: string;
    type: string;
    additionalKey: string;
