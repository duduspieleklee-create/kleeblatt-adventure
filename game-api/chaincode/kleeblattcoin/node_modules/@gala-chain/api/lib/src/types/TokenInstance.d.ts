...
export declare class TokenInstanceKey extends ChainCallDTO {
    ...
    toStringKey(): string;
    isFungible(): boolean;
    toB58EncodedString(): string;
    static fromB58EncodedString(base58String: string): TokenInstanceKey;
}
...
export declare class TokenInstance extends ChainObject {
    ...
    instanceKeyObj(): TokenInstanceKey;
...
//# sourceMappingURL=TokenInstance.d.ts.map