...
exports.TokenHold = exports.TokenBalance = exports.TokenQuantityNotUnlockedError = exports.TokenNotLockedError = exports.TokenLockedError = exports.TokenNotInBalanceError = void 0;
...
class TokenBalance extends ChainObject_1.ChainObject {
    ...
    removeInstance(instanceId, currentTime) {
        var _a;
        this.ensureInstanceIsNft(instanceId);
    ...
    unlockInstance(instanceId, name, currentTime) {
    ...
    subtractQuantity(quantity, currentTime) {
        this.ensureContainsNoNftInstances();
        this.ensureIsValidQuantityForFungible(quantity);
    ...
    isCallingUserAuthorized(hold, name, callingUser, isTokenAuthority) {
    ...
    unlockQuantity(quantity, currentTime, name, callingUser, isTokenAuthority) {
...
tslib_1.__decorate([
    (0, class_validator_jsonschema_1.JSONSchema)({
        description: "Unix epoch timestamp in milliseconds (ms) for vestingPeriodStart. " +
...
], TokenBalance.prototype, "vestingPeriodStart", void 0);
tslib_1.__decorate([
...
class TokenHold {
    ...
    getLockedVestingQuantity(currentTime) {
...
tslib_1.__decorate([
    (0, class_validator_jsonschema_1.JSONSchema)({
        description: "Unix epoch timestamp in milliseconds (ms) when the hold was created (typically the transaction time)."
    }),
...
tslib_1.__decorate([
    (0, class_validator_jsonschema_1.JSONSchema)({
        description: "Unix epoch timestamp in milliseconds (ms) for vestingPeriodStart on vesting holds; undefined for non-vesting holds."
    }),
    (0, class_validator_1.Min)(0),
    (0, class_validator_1.IsInt)(),
    (0, class_validator_1.IsOptional)(),
    tslib_1.__metadata("design:type", Object)
], TokenHold.prototype, "vestingPeriodStart", void 0);
