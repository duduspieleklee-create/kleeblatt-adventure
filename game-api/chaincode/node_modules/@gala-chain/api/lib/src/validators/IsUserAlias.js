...
(function (UserAliasValidationResult) {
    ...
    UserAliasValidationResult[UserAliasValidationResult["INVALID_FORMAT"] = 3] = "INVALID_FORMAT";
...
function requiresClientAliasOnly(args) {
    var _a;
    return (_a = args.constraints) === null || _a === void 0 ? void 0 : _a[0];
}
...
let IsUserAliasConstraint = class IsUserAliasConstraint {
    validate(value, args) {
        ...
        if (requiresClientAliasOnly(args)) {
            return meansValidUserAlias(result) && (value === null || value === void 0 ? void 0 : value.startsWith("client|"));
        }
        else {
            return meansValidUserAlias(result);
        }
    ...
    defaultMessage(args) {
        ...
        const details = (_a = customMessages[result]) !== null && _a !== void 0 ? _a : defaultMessage;
...
function IsUserAlias(options) {
    return function (object, propertyName) {
        (0, class_validator_1.registerDecorator)({
            ...
            propertyName,
            options,
            constraints: (options === null || options === void 0 ? void 0 : options.clientAliasOnly) ? [true] : [],
