...
const secp256k1 = tslib_1.__importStar(require("secp256k1"));
...
function recoverPublicKeyTestFunction(signature, obj, prefix = "") {
    ...
    const dataHash = new Uint8Array(js_sha3_1.keccak256.digest(new Uint8Array(data)));
...
describe("public key", () => {
    ...
    it("should tolerate private key beginning with 0x", () => {
        ...
        const publicKeyWithPrefix = eth_1.default.getPublicKey(keyWithPrefix);
        const publicKeyWithoutPrefix = eth_1.default.getPublicKey(ketWithoutPrefix);
...
describe("signatures", () => {
    ...
    it("should parse signature", async () => {
        // When
        const parsed = eth_1.default.parseSecp256k1Signature(signature);
        // Then
    ...
    it("should parse DER signature", async () => {
        // When
        const parsed = eth_1.default.parseSecp256k1Signature(derSignature);
        // Then
        expect(parsed).toEqual({
            r: new bn_js_1.default("b7244d62671319583ea8f30c8ef3b343cf28e7b7bd56e32b21a5920752dc95b9", "hex"),
            s: new bn_js_1.default("4a9d202b2919581bcf776f0637462cb67170828ddbcc1ea63505f6a211f9ac5b", "hex"),
    ...
    it("should parse uppercase signature", async () => {
        // When
        const parsed = eth_1.default.parseSecp256k1Signature(signature.toUpperCase());
        // Then
        expect(parsed).toEqual({
            r: new bn_js_1.default("b7244d62671319583ea8f30c8ef3b343cf28e7b7bd56e32b21a5920752dc95b9", "hex"),
            s: new bn_js_1.default("4a9d202b2919581bcf776f0637462cb67170828ddbcc1ea63505f6a211f9ac5b", "hex"),
    ...
    it("should parse uppercase DER signature", async () => {
        // When
        const parsed = eth_1.default.parseSecp256k1Signature(derSignature.toUpperCase());
        // Then
        expect(parsed).toEqual({
            r: new bn_js_1.default("b7244d62671319583ea8f30c8ef3b343cf28e7b7bd56e32b21a5920752dc95b9", "hex"),
            s: new bn_js_1.default("4a9d202b2919581bcf776f0637462cb67170828ddbcc1ea63505f6a211f9ac5b", "hex"),
    ...
    it("test metamask signatures vs galachain signatures", async () => {
        ...
        // When
        const metamaskPubKey = eth_1.default.recoverPublicKey(metamask, metamaskPayload);
...
describe("EIP-712", () => {
    ...
    const sampleKeyPair = () => ({
        ...
        publicKey: "04fc1ac1e4459eecaac724d0cb43da0f1a81736c40c72d218083524e16455b9347eec88514eb48df32f90864198a93f21e89c525d63d3c1f0f0cc056e56a965447",
    ...
    it("should sign and recover public key from EIP-712 signature", () => {
        ...
        const dto = sampleDto();
        const expectedSignature = "a38757a2bdd0d31692cdc5413524d5b8a6bb65b2b938ea11bccb043fda6b7aaa7db38c764795acbfe2e7e13bca05a40a4163dcb605e3e18718ae6e2edc932cbe1c";
        // When
        const signature = eth_1.default.getSignature(dto, eth_1.default.normalizePrivateKey(keyPair.privateKey));
        const recoveredPublicKey = eth_1.default.recoverPublicKey(signature, dto);
        const recoveredAddress = eth_1.default.getEthAddress(recoveredPublicKey);
        // Then
    ...
    it("should sign and recover public key from EIP-712 signature with chainId", () => {
        // Given
        const keyPair = sampleKeyPair();
        const privateKey = eth_1.default.normalizePrivateKey(keyPair.privateKey);
        const dto = sampleDto();
        const isValid = (signature, dto) => eth_1.default.isValid(signature, dto, keyPair.publicKey);
        const recoverPubKey = (signature, dto) => eth_1.default.recoverPublicKey(signature, dto);
        const dtoWithChainId = (chainId) => ({ ...dto, domain: { ...dto.domain, chainId } });
        // When
        dto.domain.chainId = 1;
        const signature1 = eth_1.default.getSignature(dto, privateKey);
        const dtoNoChainId = JSON.parse(JSON.stringify(dto));
        delete dtoNoChainId.domain.chainId;
        const signatureNoChainId = eth_1.default.getSignature(dtoNoChainId, privateKey);
        dto.domain.chainId = 42;
        const signature42 = eth_1.default.getSignature(dto, privateKey);
        // Then
