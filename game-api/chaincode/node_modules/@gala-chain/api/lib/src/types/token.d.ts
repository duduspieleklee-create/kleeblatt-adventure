...
export declare class CreateTokenClassDto extends SubmitCallDTO {
...
export declare class UpdateTokenClassDto extends SubmitCallDTO {
    tokenClass: TokenClassKey;
    name?: string;
    symbol?: string;
    description?: string;
...
export declare class FetchBalancesWithPaginationResponse extends ChainCallDTO {
...
export declare class TransferTokenDto extends SubmitCallDTO {
    from?: UserRef;
    to: UserRef;
