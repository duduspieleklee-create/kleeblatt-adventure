...
exports.TransferTokenDto = exports.FetchBalancesWithTokenMetadataResponse = exports.FetchBalancesWithPaginationResponse = exports.TokenBalanceWithMetadata = exports.FetchBalancesWithPaginationDto = exports.FetchBalancesDto = exports.UpdateTokenClassDto = exports.CreateTokenClassDto = exports.FetchTokenInstancesDto = exports.FetchTokenClassesResponse = exports.FetchTokenClassesWithPaginationDto = exports.FetchTokenClassesDto = void 0;
...
let CreateTokenClassDto = class CreateTokenClassDto extends dtos_1.SubmitCallDTO {
};
...
class UpdateTokenClassDto extends dtos_1.SubmitCallDTO {
}
...
class FetchBalancesWithPaginationResponse extends dtos_1.ChainCallDTO {
}
exports.FetchBalancesWithPaginationResponse = FetchBalancesWithPaginationResponse;
tslib_1.__decorate([
    (0, class_validator_jsonschema_1.JSONSchema)({ description: "List of balances with token metadata." }),
    (0, class_validator_1.ValidateNested)({ each: true }),
    (0, class_transformer_1.Type)(() => TokenBalance_1.TokenBalance),
    tslib_1.__metadata("design:type", Array)
], FetchBalancesWithPaginationResponse.prototype, "results", void 0);
tslib_1.__decorate([
    (0, class_validator_jsonschema_1.JSONSchema)({ description: "Next page bookmark." }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    tslib_1.__metadata("design:type", String)
], FetchBalancesWithPaginationResponse.prototype, "nextPageBookmark", void 0);
...
let TransferTokenDto = class TransferTokenDto extends dtos_1.SubmitCallDTO {
};
