...
let TokenClassKey = TokenClassKey_1 = class TokenClassKey extends dtos_1.ChainCallDTO {
    toString() {
    ...
    toB58EncodedString() {
        ...
        const keyList = TokenClass.buildClassKeyList(this);
        const stringKey = ChainObject_1.ChainObject.getEncodableStringKeyFromParts(keyList);
        return ChainObject_1.ChainObject.encodeToBase58(stringKey);
    }
    static fromB58EncodedString(base58String) {
        const stringKey = ChainObject_1.ChainObject.decodeFromBase58(base58String);
        const parts = ChainObject_1.ChainObject.getPartsFromEncodableStringKey(stringKey, 4);
        const tokenClassKey = new TokenClassKey_1();
...
exports.TokenClassKey = TokenClassKey = TokenClassKey_1 = tslib_1.__decorate([
