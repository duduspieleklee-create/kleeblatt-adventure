...
export declare abstract class ChainObject {
    ...
    static getEncodableStringKeyFromParts(parts: string[]): string;
    static getPartsFromEncodableStringKey(stringKey: string, expectedParts: number): string[];
    static encodeToBase58(stringKey: string): string;
    static decodeFromBase58(base58String: string): string;
}
//# sourceMappingURL=ChainObject.d.ts.map