...
class ChainObject {
    ...
    copy() {
        ...
        return ChainObject.deserialize(this.constructor, this.toPlainObject());
    }
    ...
    static getEncodableStringKeyFromParts(parts) {
    ...
    static getPartsFromEncodableStringKey(stringKey, expectedParts) {
    ...
    static encodeToBase58(stringKey) {
        const buffer = Buffer.from(stringKey);
        return bs58_1.default.encode(buffer);
    }
    static decodeFromBase58(base58String) {
        const decoded = bs58_1.default.decode(base58String);
