...
tslib_1.__decorate([
    (0, class_validator_jsonschema_1.JSONSchema)({
        description: "Unix epoch timestamp in milliseconds (ms) when the swap request should expire. " +
...
tslib_1.__decorate([
    (0, class_validator_jsonschema_1.JSONSchema)({
        description: "(optional) ChainKey 0 — Unix epoch timestamp in milliseconds (ms) of swap creation; partial query lower bound."
    }),
    (0, class_validator_1.IsOptional)(),
...
exports.FetchTokenSwapsDto = FetchTokenSwapsDto = tslib_1.__decorate([
    (0, class_validator_jsonschema_1.JSONSchema)({
        description: "Legacy FetchTokenSwapsDto. Provide a created-time lower bound as a Unix epoch timestamp in milliseconds (ms) to limit results, or leave empty to query all swaps."
    })
], FetchTokenSwapsDto);
