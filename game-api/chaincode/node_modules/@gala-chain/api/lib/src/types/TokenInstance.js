...
let TokenInstanceKey = TokenInstanceKey_1 = class TokenInstanceKey extends dtos_1.ChainCallDTO {
    ...
    static fromB58EncodedString(base58String) {
        ...
        const parts = ChainObject_1.ChainObject.getPartsFromEncodableStringKey(stringKey, 5);
        const tokenInstanceKey = new TokenInstanceKey_1();
        ...
        tokenInstanceKey.instance = new bignumber_js_1.BigNumber(parts[4]);
