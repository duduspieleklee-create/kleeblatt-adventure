...
let LockTokenDto = class LockTokenDto extends dtos_1.SubmitCallDTO {
};
...
], LockTokenDto.prototype, "vestingPeriodStart", void 0);
exports.LockTokenDto = LockTokenDto = tslib_1.__decorate([
    (0, class_validator_jsonschema_1.JSONSchema)({
        description: "Describes an action to lock a token."
    })
], LockTokenDto);
let LockTokensDto = class LockTokensDto extends dtos_1.SubmitCallDTO {
};
...
tslib_1.__decorate([
    (0, class_validator_jsonschema_1.JSONSchema)({
        description: "Unix epoch timestamp in milliseconds (ms) when token holds created by this lock expire. " +
...
let UnlockTokenDto = class UnlockTokenDto extends dtos_1.SubmitCallDTO {
};
...
let UnlockTokensDto = class UnlockTokensDto extends dtos_1.SubmitCallDTO {
};
