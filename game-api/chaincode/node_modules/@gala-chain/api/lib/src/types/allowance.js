...
let DeleteAllowancesDto = class DeleteAllowancesDto extends dtos_1.SubmitCallDTO {
};
...
tslib_1.__decorate([
    (0, class_validator_jsonschema_1.JSONSchema)({
        description: "Unix epoch timestamp in milliseconds (ms) of allowance creation, for partial queries. Optional."
    }),
    (0, class_validator_1.IsPositive)(),
    (0, class_validator_1.IsInt)(),
    (0, class_validator_1.IsOptional)(),
    tslib_1.__metadata("design:type", Number)
], DeleteAllowancesDto.prototype, "created", void 0);
...
let GrantAllowanceDto = class GrantAllowanceDto extends dtos_1.SubmitCallDTO {
};
...
tslib_1.__decorate([
    (0, class_validator_jsonschema_1.JSONSchema)({
        description: "Unix epoch timestamp in milliseconds (ms) when the allowances should expire. " +
 ...
 */
let HighThroughputGrantAllowanceDto = class HighThroughputGrantAllowanceDto extends dtos_1.SubmitCallDTO {
};
...
let FulfillMintAllowanceDto = class FulfillMintAllowanceDto extends dtos_1.SubmitCallDTO {
};
...
tslib_1.__decorate([
    (0, class_validator_jsonschema_1.JSONSchema)({
        description: "Unix epoch timestamp in milliseconds (ms) when the allowance expires. " + "0 means it never expires."
    }),
...
let RefreshAllowancesDto = class RefreshAllowancesDto extends dtos_1.SubmitCallDTO {
};
