...
describe("RegisterUserDto", () => {
    describe("validation and serialization", () => {
        it("should validate and serialize with single publicKey", async () => {
            ...
            // When
            const instance = (0, class_transformer_1.plainToInstance)(dtos_1.RegisterUserDto, input);
            const errors = await (0, class_validator_1.validate)(instance);
            const serialized = (0, class_transformer_1.instanceToPlain)(instance);
            // Then
        ...
        it("should fail validation when signers contains invalid values", async () => {
            ...
            const input = {
                ...
                signers: ["client|u1", 123, "client|u3"]
            };
            // When
            const instance = (0, class_transformer_1.plainToInstance)(dtos_1.RegisterUserDto, input);
            const errors = await (0, class_validator_1.validate)(instance);
    ...
    describe("signature serialization", () => {
        it("should sign and verify signature with single publicKey", () => {
            // Given
            const { privateKey, publicKey } = utils_1.signatures.genKeyPair();
            const dto = new dtos_1.RegisterUserDto();
            dto.uniqueKey = "test-unique-key-signature";
            dto.user = "client|test-user";
        ...
        it("should fail to verify signature with invalid key", () => {
            // Given
            const { privateKey } = utils_1.signatures.genKeyPair();
            const invalid = utils_1.signatures.genKeyPair();
            const dto = new dtos_1.RegisterUserDto();
...
//# sourceMappingURL=RegisterUserDto.spec.js.map