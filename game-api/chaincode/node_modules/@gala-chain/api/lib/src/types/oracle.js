...
tslib_1.__decorate([
    (0, class_validator_jsonschema_1.JSONSchema)({
        description: "Unix epoch timestamp in milliseconds (ms) for the date/time at which this price / exchange rate was calculated or estimated."
    }),
...
tslib_1.__decorate([
    (0, class_validator_jsonschema_1.JSONSchema)({
        description: "Unix epoch timestamp in milliseconds (ms) for the date/time at which this assertion " +
